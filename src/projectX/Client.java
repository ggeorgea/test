		...
		switch (event.getTypeCase().name()) {
			...
			for(ResourceAllocation rA : event.getInitialAllocation().getResourceAllocationList()){
				if(rA.getPlayer().getIdValue()==myID){
					...
					Catan.out1.print("\n"+"you got "+rA.getResources().getBrick()+", lumber: "+rA.getResources().getLumber()+", wool: "+rA.getResources().getWool()+", grain: "+rA.getResources().getGrain()+", ore:"+rA.getResources().getOre());
				}
			}
			gameStarted = true;
			break;
			case "CHATMESSAGE":
			Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+ ": "+event.getChatMessage());
			break;
			case "ERROR":
			Catan.out1.print("\n"+"Error: "+event.getError().getDescription());
			break;
			case "ROLLED":
			if(event.getInstigator().getIdValue()!=myID){
				Catan.out1.print("\n"+ "player "+event.getInstigator().getIdValue()+" rolled a "+(event.getRolled().getA() + event.getRolled().getB())+"!");
			}else{
				Catan.out1.print("\n"+ "You rolled a "+(event.getRolled().getA() + event.getRolled().getB())+"!");
			}
			...
			Catan.out1.print("\n"+"player "+roadplayer.getID()+" placed a road at ("+rx1+", "+ry1+"),("+rx2+", "+ry2+")");
			...
			Catan.out1.print("\n"+"player "+thisplayer.getID()+" placed a settlement at ("+bx+", "+by+")");
			...
			Catan.out1.print("\n"+"player "+cityPlayer.getID()+" placed a settlement at ("+cx+", "+cy+")");
			...
			if(event.getInstigator().getIdValue()!=myID){
				switch(typeOfEvent){
					case 1:
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" bought a dev card");
					break;
					case 3:
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" bought a victory ponint dev card");
					break;
					case 2:
					Catan.out1.print("\n"+"error: should not know type of card");
					break;
				}
			}else{
				switch(typeOfEvent){
					case 1:
					Catan.out1.print("\n"+"error: should know type of card");
					break;
					case 3:
					Catan.out1.print("\n"+"you bought a victory ponint dev card");
					break;
					case 2:		
					...
					switch(playableType){
						...
						case 1:
						myRoadBuildingCards++;
						Catan.out1.print("\n"+"you bought a road building card");
							 // MONOPOLY = 
						case 2:
						myMonopolyCards++;
						Catan.out1.print("\n"+"you bought a monopoly card");
							//  YEAR_OF_PLENTY = 
						case 3: 							
						yearOfPlentyCards++;
						Catan.out1.print("\n"+"you bought a year Of Plenty Card");
					}
			...
			if(event.getInstigator().getIdValue()!=myID){
				...
				switch(playableType){
					//KNIGHT 
					case 0:
					Catan.out1.print("\n"+"player "+instID+" played a knight");
					// ROAD_BUILDING = 
					case 1:
					Catan.out1.print("\n"+"player "+instID+" played a road building card");
					// MONOPOLY = 
					case 2:
					Catan.out1.print("\n"+"player "+instID+" played a monopoly card");
					//  YEAR_OF_PLENTY = 
					case 3: 
					Catan.out1.print("\n"+"player "+instID+" played a year Of Plenty Card");
				}
				...
				switch(playableType){
					...
					case 2:
					myMonopolyCards--;
					Catan.out1.print("\n"+"you played a monopoly card");
						//  YEAR_OF_PLENTY = 
					case 3: 							
					yearOfPlentyCards--;
					Catan.out1.print("\n"+"you played a year Of Plenty Card");
				}
			}
			break;
			case "ROBBERMOVED":
			...
			Catan.out1.print("\n"+"the robber was moved to: ("+nx+", "+ny+") by player"+ event.getInstigator().getIdValue());
			break;
			case "RESOURCESTOLEN":
			...
			if(event.getInstigator().getIdValue()==myID){
				switch(reco){
					//BRICK
					case  1:
					Catan.out1.print("\n"+"you stole brick X"+quant+" from player "+event.getResourceStolen().getVictim().getIdValue());
					mybrick+=quant;
					break;
					//LUMBER
					case  2:	
					Catan.out1.print("\n"+"you stole LUMBER X"+quant+" from player "+event.getResourceStolen().getVictim().getIdValue());
					mylumber+=quant;
					break;
					//WOOL
					case  3:	
					Catan.out1.print("\n"+"you stole WOOL X"+quant+" from player "+event.getResourceStolen().getVictim().getIdValue());
					mywool+=quant;
					break;
					//GRAIN
					case  4:	
					Catan.out1.print("\n"+"you stole GRAIN X"+quant+" from player "+event.getResourceStolen().getVictim().getIdValue());
					mygrain+=quant;
					break;
					//ORE
					case  5:	
					Catan.out1.print("\n"+"you stole ORE X"+quant+" from player "+event.getResourceStolen().getVictim().getIdValue());
					myore+=quant;
					break;
				}
			}else{
				if(event.getResourceStolen().getVictim().getIdValue() == myID){
					switch(reco){
						//BRICK
						case  1:
						Catan.out1.print("\n"+"you lost brick X"+quant+" to player "+event.getInstigator().getIdValue());
						mybrick-=quant;
						break;
						//LUMBER
						case  2:	
						Catan.out1.print("\n"+"you lost LUMBER X"+quant+" to player "+event.getInstigator().getIdValue());
						mylumber-=quant;
						break;
						//WOOL
						case  3:	
						Catan.out1.print("\n"+"you lost WOOL X"+quant+" to player "+event.getInstigator().getIdValue());
						mywool-=quant;
						break;
						//GRAIN
						case  4:	
						Catan.out1.print("\n"+"you lost GRAIN X"+quant+" to player "+event.getInstigator().getIdValue());
						mygrain-=quant;
						break;
						//ORE
						case  5:	
						Catan.out1.print("\n"+"you lost ORE X"+quant+" to player "+event.getInstigator().getIdValue());
						myore-=quant;
						break;
					}
				}
				else{
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" stole "+quant+" resources from player"+ event.getResourceStolen().getVictim().getIdValue());
				}
			}
			break;
			case "RESOURCECHOSEN":
			...
			if(event.getInstigator().getIdValue()!=myID){
				switch(event.getResourceChosenValue()){
					//GENERIC
					case  0:
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" chose generic");
					break;
					//BRICK
					case  1:
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" chose brick");
					break;
					//LUMBER
					case  2:					
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" chose lumber");
					break;
					//WOOL
					case  3:						
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" chose wool");
					break;
					//GRAIN
					case  4:						
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" chose grain");
					break;
					//ORE
					case  5:						
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" chose ore");
					break;
			...
			if(event.getInstigator().getIdValue()!=myID){
				Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+"discarded brick: "+brick+", lumber: "+lumber+", wool: "+wool+", grain: "+grain+", ore:"+ore);

			}else{
				Catan.out1.print("\n"+"you discarded brick: "+brick+", lumber: "+lumber+", wool: "+wool+", grain: "+grain+", ore:"+ore);
				mybrick -= brick;
				mylumber -= lumber;
				mywool -= wool;
				mygrain-= grain;
			...
			if(event.getInstigator().getIdValue()!=myID){
				Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" traded with the bank, GIVING: brick "+brickO+", lumber "+lumberO+", wool "+woolO+", grain "+grainO+", ore "+oreO+" GETTING: brick "+brickW+", lumber "+lumberW+", wool "+woolW+", grain "+grainW+", ore "+oreW);
			}else{
				Catan.out1.print("\n"+"you traded with the bank, GIVING: brick "+brickO+", lumber "+lumberO+", wool "+woolO+", grain "+grainO+", ore "+oreO+" GETTING: brick "+brickW+", lumber "+lumberW+", wool "+woolW+", grain "+grainW+", ore "+oreW);
			...
			if(event.getInstigator().getIdValue()!=myID){
				if(event.getPlayerTradeAccepted().getOther().getIdValue()!=myID){
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" traded with player "+ event.getPlayerTradeAccepted().getOther().getIdValue()+", GIVING: brick "+brickO+", lumber "+lumberO+", wool "+woolO+", grain "+grainO+", ore "+oreO+" GETTING: brick "+brickW+", lumber "+lumberW+", wool "+woolW+", grain "+grainW+", ore "+oreW);
				}
				else{
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" traded with you , GIVING: brick "+brickO+", lumber "+lumberO+", wool "+woolO+", grain "+grainO+", ore "+oreO+" GETTING: brick "+brickW+", lumber "+lumberW+", wool "+woolW+", grain "+grainW+", ore "+oreW);
					mybrick -= brickW-brickO;
					mylumber -= lumberW- lumberO;
					mywool -= woolW-woolO;
					mygrain -= grainW-grainO;
				...
				Catan.out1.print("\n"+"you traded with player "+ event.getPlayerTradeAccepted().getOther().getIdValue()+", GIVING: brick "+brickO+", lumber "+lumberO+", wool "+woolO+", grain "+grainO+", ore "+oreO+" GETTING: brick "+brickW+", lumber "+lumberW+", wool "+woolW+", grain "+grainW+", ore "+oreW);
			...
			if(event.getInstigator().getIdValue()!=myID){
				if(event.getPlayerTradeAccepted().getOther().getIdValue()!=myID){
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" wants to trade with player "+ event.getPlayerTradeAccepted().getOther().getIdValue()+", GIVING: brick "+brickO+", lumber "+lumberO+", wool "+woolO+", grain "+grainO+", ore "+oreO+" GETTING: brick "+brickW+", lumber "+lumberW+", wool "+woolW+", grain "+grainW+", ore "+oreW);
				}
				else{
					Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" wants to trade with you , GIVING: brick "+brickO+", lumber "+lumberO+", wool "+woolO+", grain "+grainO+", ore "+oreO+" GETTING: brick "+brickW+", lumber "+lumberW+", wool "+woolW+", grain "+grainW+", ore "+oreW);
					Catan.out1.print("\n"+"what is your response?");
				}
			}else{
				Catan.out1.print("\n"+"you want to trade with player "+ event.getPlayerTradeAccepted().getOther().getIdValue()+", GIVING: brick "+brickO+", lumber "+lumberO+", wool "+woolO+", grain "+grainO+", ore "+oreO+" GETTING: brick "+brickW+", lumber "+lumberW+", wool "+woolW+", grain "+grainW+", ore "+oreW);
			...
			for(Hex hex:hexes){
				...
				projectX.Hex boardHex = (projectX.Hex)l1.getContains();
			...
			for(Harbour habour: habours){
				...
				switch(rec){
					...
					break;
					default:
					Catan.out1.print("\n"+"error allocating port resource");
				}
			...
			for(int i = 0; i<event.getMonopolyResolution().getTheftsCount();i++){
				...
				if(event.getInstigator().getIdValue()==myID){
					switch(Areco){
						//BRICK
						case  1:
						Catan.out1.print("\n"+"you stole brick X"+Aquant+" from player "+thisSteal.getVictim().getIdValue());
						mybrick+=Aquant;
						break;
						//LUMBER
						case  2:	
						Catan.out1.print("\n"+"you stole LUMBER X"+Aquant+" from player "+thisSteal.getVictim().getIdValue());
						mylumber+=Aquant;
						break;
						//WOOL
						case  3:	
						Catan.out1.print("\n"+"you stole WOOL X"+Aquant+" from player "+thisSteal.getVictim().getIdValue());
						mywool+=Aquant;
						break;
						//GRAIN
						case  4:	
						Catan.out1.print("\n"+"you stole GRAIN X"+Aquant+" from player "+thisSteal.getVictim().getIdValue());
						mygrain+=Aquant;
						break;
						//ORE
						case  5:	
						Catan.out1.print("\n"+"you stole ORE X"+Aquant+" from player "+thisSteal.getVictim().getIdValue());
						myore+=Aquant;
						break;
					}
				}else{
					if(thisSteal.getVictim().getIdValue() == myID){
						switch(Areco){
							//BRICK
							case  1:
							Catan.out1.print("\n"+"you lost brick X"+Aquant+" to player "+event.getInstigator().getIdValue());
							mybrick-=Aquant;
							break;
							//LUMBER
							case  2:	
							Catan.out1.print("\n"+"you lost LUMBER X"+Aquant+" to player "+event.getInstigator().getIdValue());
							mylumber-=Aquant;
							break;
							//WOOL
							case  3:	
							Catan.out1.print("\n"+"you lost WOOL X"+Aquant+" to player "+event.getInstigator().getIdValue());
							mywool-=Aquant;
							break;
							//GRAIN
							case  4:	
							Catan.out1.print("\n"+"you lost GRAIN X"+Aquant+" to player "+event.getInstigator().getIdValue());
							mygrain-=Aquant;
							break;
							//ORE
							case  5:	
							Catan.out1.print("\n"+"you lost ORE X"+Aquant+" to player "+event.getInstigator().getIdValue());
							myore-=Aquant;
							break;
						}
					}
					else{
						Catan.out1.print("\n"+"player "+event.getInstigator().getIdValue()+" stole "+Aquant+" resources from player"+thisSteal.getVictim().getIdValue());
					}
				}					
			}					
			break;
