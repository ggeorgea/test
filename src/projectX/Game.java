...
//-----Constructors-----//
	...
	public Game(String id, projectX.Board board, ArrayList<ResourceCard> ore, ArrayList<ResourceCard> grain,
...
//-----Getters and Setters-----//
	...
	public projectX.Board getBoard() {
		return board;
	}

	public void setBoard(projectX.Board board) {
		this.board = board;
	}
