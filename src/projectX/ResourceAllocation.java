...
public class ResourceAllocation {
	...
	public static ArrayList<intergroup.board.Board.ResourceAllocation> resourceAllocation(int hexValue, Game game1, Scanner scanner) {
		...
		ArrayList<projectX.Player> players = game1.getPlayers();
	...
	public static void resetNewResources(ArrayList<projectX.Player> players) {
	...
	public static String getIntersectionResources(Board board, Coordinate nearbyIntersection, Hex hex, Game game1) {
		...
		projectX.Player owner = ((Intersection) board.getLocationFromCoordinate(nearbyIntersection).getContains()).getOwner();
	...
	//returns the resource if the bank runs out of that resource card
	//null otherwise
	public static String getResources(projectX.Player player, String terrain, Game game1, int n) {
	...
	//bank does not have
	public static void removeIllegalResources(ArrayList<projectX.Player> players, ArrayList<String> illegalResources) {
		
		for (int i = 0; i < players.size(); i++) {
			
			projectX.Player player = players.get(i);
			ArrayList<ResourceCard> newResourceCards = player.getNewResourceCards();
	...
	public static ArrayList<intergroup.board.Board.ResourceAllocation> setResources(ArrayList<projectX.Player> players) {
		ArrayList<intergroup.board.Board.ResourceAllocation> proRecAl = new ArrayList<intergroup.board.Board.ResourceAllocation>();
		for (int i = 0; i < players.size(); i++) {
			projectX.Player player = players.get(i);
